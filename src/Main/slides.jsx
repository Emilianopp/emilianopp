...
export default function Slides() {
  ...
  return (
    ...
    <div>
      ...
      < p className='introduction'>I
      m a fourth year Data Science student </p>
      < p className='introduction'>I currently study at the University of Western Ontario </p>
      < p className='introduction'>This is a space where I showcase some of my work</p>
